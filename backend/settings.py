...
MIDDLEWARE = [
    ...
    'core.tracking.VisitLogMiddleware',
]
...
if not DEBUG:
    ...
    CSRF_TRUSTED_ORIGINS = ['https://www.zaidkaraymeh.com/', 'https://www.zaidkaraymeh.com', 'https://zaidkaraymeh.com/','https://zaidkaraymeh.com', 
